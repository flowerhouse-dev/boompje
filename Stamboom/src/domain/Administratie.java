...
public class Administratie implements java.io.Serializable {
    ...
    private transient ObservableList<Geslacht> observableGeslachten;
    ...
    public Administratie() {
        ...
        ArrayList<Geslacht> geslachten = new ArrayList<>();
        geslachten.add(Geslacht.MAN);
        geslachten.add(Geslacht.VROUW);
        observableGeslachten = FXCollections.observableArrayList(geslachten);    
    ...
    public Gezin addHuwelijk(Persoon ouder1, Persoon ouder2, Calendar huwdatum) {
        ...
        { 
            System.out.println("ongehuwd gezin");
...
//    }
    public ObservableList<Persoon> getPersonen() {
        //return FXCollections.observableArrayList(this.personen);
    ...
    public ObservableList<Gezin> getGezinnen() {
        //return FXCollections.observableArrayList(this.gezinnen);
        return observableGezinnen;
    }
    
    public ObservableList<Geslacht> getGeslachten() {
        return observableGeslachten;
    }
